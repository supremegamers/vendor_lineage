# Copyright (C) 2018-2022 The -lmodroidOS Project
...
ifneq ($(KERNEL_NO_GCC), true)
    ...
    TOOLS_PATH_OVERRIDE += PATH=$(BUILD_TOP)/prebuilts/tools-lmodroid/$(HOST_PREBUILT_TAG)/bin:$(TARGET_KERNEL_CLANG_PATH)/bin:$$PATH
endif
